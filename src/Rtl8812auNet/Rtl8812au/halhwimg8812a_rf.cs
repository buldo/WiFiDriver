...
public static class halhwimg8812a_rf
{
    ...
    public static void odm_read_and_config_mp_8812a_txpwr_lmt(_adapter dm)
    {
        u32 i = 0;

        var array_len = array_mp_8812a_txpwr_lmt.Length;
        var array = array_mp_8812a_txpwr_lmt;
        ...
        for (i = 0; i < array_len; i += 7)
        {
            ...
            string regulation = array[i];
            string band = array[i + 1];
            string bandwidth = array[i + 2];
            string rate = array[i + 3];
            string rf_path = array[i + 4];
            string chnl = array[i + 5];
            string val = array[i + 6];
    ...
    private static string[] array_mp_8812a_txpwr_lmt =
    {
